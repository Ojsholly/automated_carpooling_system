CREATE TABLE `cars_list` (
	...
	PRIMARY KEY (`id`),
	UNIQUE `U_cars_list_year_make_model` (`year`, `make`, `model`),
	INDEX `I_cars_list_year` (`year`),
	INDEX `I_cars_list_make` (`make`),
	INDEX `I_cars_list_model` (`model`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO cars_list (year, make, model) VALUES (1909, 'Ford', 'Model T'),
