...
<link rel="shortcut icon" href="<?php echo e(asset('landing/images/icon.png')); ?>" />
	...
	<!-- css files -->
    <link href=" <?php echo e(asset('landing/css/bootstrap.css')); ?>" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href=" <?php echo e(asset('landing/css/style.css')); ?> " rel='stylesheet' type='text/css' /><!-- custom css -->
    <link href=" <?php echo e(asset('landing/css/font-awesome.min.css')); ?> " rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->

	<link href=" <?php echo e(asset('landing/css/css_slider.css')); ?> " type="text/css" rel="stylesheet" media="all">
...
<header>
	<div class="container">
		...
		<nav class="py-md-4 py-3 d-lg-flex">
			<div id="logo">
				<h1 class="mt-md-0 mt-2"> <a href="<?php echo e(url('/')); ?>"><span class="fa fa-car"></span> Carpooling System </a></h1>
			</div>
            ...
            <?php if(Route::has('login')): ?>
                ...
                <ul class="menu m1-auto mt-1">
                    <li class=""><a href="<?php echo e(url('/dashboard')); ?>"><span class="fa fa-dashboard"></span> Dashboard</a></li>
                    <li class=""><a href="<?php echo e(url('/rides/find-ride')); ?>"><span class="fa fa-search"></span> Find a Ride</a></li>
                    <li class=""><a href="<?php echo e(url('/rides/add-new-ride')); ?>"><span class="fa fa-plus"></span> Add New Ride</a></li>
                </ul>
                <?php else: ?>
                <ul class="menu ml-auto mt-1">
                    <li class=""><a href="<?php echo e(url('/register')); ?>"><span class="fa fa-user-plus"></span> Sign Up</a></li>
                    <li class=""><a href="<?php echo e(url('/login')); ?>"><span class="fa fa-sign-in"></span> Log In</a></li>
                </ul>
                <?php endif; ?>
            <?php endif; ?>
						...
						<div class="container">
							<div class="w3layouts-banner-info">
								...
								<div class="buttons mt-4">
									<a href="<?php echo e(url('/rides/find-ride')); ?> " class="btn mr-2">Find a Ride</a>
									<a href="<?php echo e(url('/rides/add-new-ride')); ?> " class="btn">Add New Ride</a>
								</div>
							</div>
						</div>
					</div>
	...
	<div class="container py-lg-5 py-sm-4">
		<div class="row">
			<div class="col-lg-6 about-left">
                ...
                <a class="btn btn-lg btn-royal text-center btn-royal" href="<?php echo e(url('/rides/add-new-ride')); ?>">Add New Ride</a>
            </div>
			<div class="col-lg-6 about-right text-lg-right mt-lg-0 mt-5">
				<img src=" <?php echo e(asset('landing/images/driver.jpg')); ?> " alt="" class="img-fluid abt-image" />
			</div>
		</div>
	</div>
</section>
	    ...
	    <div class="row inner-sec-w3layouts-w3pvt-lauinfo">
			<div class="col-md-3 col-sm-6 col-6 destinations-grids text-center">
				...
				<div class="image-position position-relative">
					<img src="<?php echo e(asset('landing/images/china.jpg')); ?>" class="img-fluid" alt="">
					<div class="rating">
						<ul>
				...
				<div class="destinations-info">
					<div class="caption mb-lg-3">
						<h4>China</h4>
						<a href="<?php echo e(url('/rides/add-new-ride')); ?> ">Book Now</a>
					</div>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 col-6 destinations-grids text-center">
				...
				<div class="image-position position-relative">
					<img src="<?php echo e(asset('landing/images/malaysia.jpg')); ?>" class="img-fluid" alt="">
					<div class="rating">
						<ul>
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
			...
			<div class="col-md-3 col-sm-6 col-6 destinations-grids text-center mt-md-0 mt-4">
				...
				<div class="image-position position-relative">
					<img src="<?php echo e(asset('landing/images/japan.jpg')); ?>" class="img-fluid" alt="">
					<div class="rating">
						<ul>
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
			...
			<div class="col-md-3 col-sm-6 col-6 destinations-grids text-center mt-md-0 mt-4">
				...
				<div class="image-position position-relative">
					<img src="<?php echo e(asset('landing/images/singapore.jpg')); ?>" class="img-fluid" alt="">
					<div class="rating">
						<ul>
							<li><span class="fa fa-star"></span></li>
							<li><span class="fa fa-star"></span></li>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\automated_carpooling_system\resources\views/index.blade.php ENDPATH**/ ?>